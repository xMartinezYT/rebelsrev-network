...
if (process.env.DATABASE_URL) {
  ...
  // Para desarrollo: base datos SQLite en memoria
...
const Affiliate = sequelize.define('Affiliate', {
  ...
  commission_rate: { type: DataTypes.DECIMAL(5, 4), defaultValue: 0.5000 },
  total_clicks: { type: DataTypes.INTEGER, defaultValue: 0 },
  total_conversions: { type: DataTypes.INTEGER, defaultValue: 0 },
  total_revenue: { type: DataTypes.DECIMAL(10, 2), defaultValue: 0.00 },
  displayed_revenue: { type: DataTypes.DECIMAL(10, 2), defaultValue: 0.00 },
  pending_payment: { type: DataTypes.DECIMAL(10, 2), defaultValue: 0.00 },
...
const Campaign = sequelize.define('Campaign', {
  ...
  total_revenue: { type: DataTypes.DECIMAL(12, 2), defaultValue: 0.00 },
  network_share: { type: DataTypes.DECIMAL(12, 2), defaultValue: 0.00 },
  affiliate_share: { type: DataTypes.DECIMAL(12, 2), defaultValue: 0.00 }
}, {
  tableName: 'campaigns',
  timestamps: true
});
...
const Click = sequelize.define('Click', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  tracking_id: { type: DataTypes.UUID, unique: true, allowNull: false, defaultValue: DataTypes.UUIDV4 },
  affiliate_id: { type: DataTypes.INTEGER, allowNull: false },
  campaign_id: { type: DataTypes.INTEGER, allowNull: false },
  sub_id: { type: DataTypes.STRING(50) },
  ip_address: { type: DataTypes.STRING(45) },
  user_agent: { type: DataTypes.TEXT },
  country: { type: DataTypes.STRING(2) },
  is_converted: { type: DataTypes.BOOLEAN, defaultValue: false },
  revenue: { type: DataTypes.DECIMAL(8, 2), defaultValue: 0.00 },
...
// Funciones de inicialización y seed
...
const seedDatabase = async () => {
  try {
    ...
    // Usuarios de ejemplo (admin y afiliados)
